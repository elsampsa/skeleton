...
__all__ = [
    ...
    "FancyHelloWorld3",
    "FancyHelloWorld4",
    "FancyHelloWorld5"]  # this declares what is exposed for the API user in the "from skeleton import .." namespace
...
class FancyHelloWorld4(FancyHelloWorld):
    ...
    def AttributeCheck_vague(obj):
        ...
        # we could do any sort of custom checks here.  Remember to return False
        # or True
    ...
    parameter_defs = {
        ...
        # :param age: person's age : integer, optional, default value = 0
        "age": (int, 0),
        # :param vague: an object of unspecified type.  Custom checked wit AttributeCheck_vague (see source code for more details)
        "vague": AttributeCheck_vague
    }
...
class FancyHelloWorld5(FancyHelloWorld):
    ...
    parameter_defs = {
        ...
        # :param age: person's age : integer, optional, default value = 0
        "age": (int, 0),
        # :param vague: an object of unspecified type. The "checking" is done with a function that returns always True (=everything goes)
        "vague": noCheck
    }
